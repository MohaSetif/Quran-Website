        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2 group">
              <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-600 rounded-lg flex items-center justify-center shadow-lg shadow-amber-900/20 group-hover:scale-110 transition-transform">
                <span className="text-white font-bold text-xl">ص</span>
              </div>
              <span className="text-xl font-bold bg-gradient-to-r from-white to-neutral-400 bg-clip-text text-transparent italic">Salah Companion</span>
            </div>

            <div className="hidden md:flex space-x-8">
              <a href="#features" className="text-neutral-400 hover:text-amber-500 transition-colors font-medium">Features</a>
              <a href="#how-it-works" className="text-neutral-400 hover:text-amber-500 transition-colors font-medium">How It Works</a>
              <a href="#download" className="text-neutral-400 hover:text-amber-500 transition-colors font-medium">Download</a>
              <a href="#about" className="text-neutral-400 hover:text-amber-500 transition-colors font-medium">About</a>
            </div>

            <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="md:hidden text-neutral-400 hover:text-white transition-colors">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-neutral-900 border-b border-white/5 animate-in slide-in-from-top duration-300">
            <div className="px-4 py-4 space-y-3">
              <a href="#features" onClick={() => setMobileMenuOpen(false)} className="block text-neutral-300 hover:text-amber-500 py-2">Features</a>
              <a href="#how-it-works" onClick={() => setMobileMenuOpen(false)} className="block text-neutral-300 hover:text-amber-500 py-2">How It Works</a>
              <a href="#download" onClick={() => setMobileMenuOpen(false)} className="block text-neutral-300 hover:text-amber-500 py-2">Download</a>
              <a href="#about" onClick={() => setMobileMenuOpen(false)} className="block text-neutral-300 hover:text-amber-500 py-2">About</a>
            </div>
          </div>
        )}
      </nav>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group p-8 rounded-3xl bg-neutral-900/50 border border-white/5 hover:border-amber-500/20 hover:bg-neutral-900/80 transition-all duration-500 hover:-translate-y-2">
                <div className="w-16 h-16 rounded-2xl bg-amber-500/10 flex items-center justify-center text-amber-500 mb-6 group-hover:scale-110 transition-transform duration-500 group-hover:bg-amber-500 group-hover:text-white">
                  {feature.icon}
                </div>
      ...
      <section id="download" className="py-24 px-4 bg-gradient-to-br from-amber-600 to-orange-700 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl mb-12 text-white/90 max-w-2xl mx-auto">
            Join thousands of Muslims worldwide who use Salah Companion to stay consistent with their prayers and Quran reading.
          </p>
          ...
          <div className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-[3rem] p-12 max-w-2xl mx-auto shadow-2xl">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="bg-white p-4 rounded-3xl shadow-inner">
                <div className="aspect-square bg-gradient-to-br from-neutral-50 to-neutral-200 rounded-2xl flex items-center justify-center border-2 border-neutral-100">
                  <div className="text-center text-neutral-800">
                    <div className="text-7xl mb-2">📱</div>
                    <div className="font-bold text-lg">QR Code</div>
                    <div className="text-sm text-neutral-500">Scan to Download</div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-left">
                ...
                <div className="space-y-4">
                  <button className="w-full bg-black text-white px-8 py-4 rounded-2xl font-bold hover:bg-neutral-900 transition-all flex items-center justify-center space-x-3 group active:scale-95">
                    <span className="text-2xl group-hover:scale-125 transition-transform">🤖</span>
                    <span className="text-lg">Get on Android</span>
                  </button>
                  <button className="w-full bg-neutral-100 text-neutral-900 px-8 py-4 rounded-2xl font-bold hover:bg-white transition-all flex items-center justify-center space-x-3 group active:scale-95">
                    <span className="text-2xl group-hover:scale-125 transition-transform">🍎</span>
                    <span className="text-lg">Get on iOS</span>
                  </button>
                </div>
              </div>
            </div>
      ...
      <section id="about" className="py-24 px-4 bg-neutral-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-8 text-lg text-neutral-400 leading-relaxed font-light">
            <p>
              In today's fast-paced world, maintaining a consistent prayer routine can be challenging. We created <span className="text-white font-medium italic">Salah Companion</span> to help Muslims around the globe stay connected with their faith through accurate prayer times and beautiful recitations.
            </p>
            <p>
          ...
          <div className="grid md:grid-cols-3 gap-12 items-center text-center md:text-left">
            <div>
              <div className="flex items-center justify-center md:justify-start space-x-2 mb-6 group">
                ...
                <span className="text-xl font-bold text-white italic">Salah Companion</span>
              </div>
            ...
            <div className="flex justify-center space-x-8">
              ...
              <a href="mailto:contact@salahcompanion.app" className="hover:text-amber-500 transition-colors">Contact</a>
            </div>

            <div className="md:text-right">
              <p className="font-medium text-neutral-400 mb-2">© 2024 Salah Companion</p>
